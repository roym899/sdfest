...
def compute_degree_cm_mAP(final_results, synset_names, log_dir, degree_thresholds=[360], shift_thresholds=[100], iou_3d_thresholds=[0.1], iou_pose_thres=0.1, use_matches_for_pose=False):
    ...
    for cls_id in range(1, num_classes):
        class_name = synset_names[cls_id]
        print(class_name)
        print('3D IoU at 25: {:.3f}'.format(iou_aps[cls_id, iou_thres_list.index(0.25)] * 100))
        print('3D IoU at 50: {:.3f}'.format(iou_aps[cls_id, iou_thres_list.index(0.5)] * 100))
        print('3D IoU at 75: {:.1f}'.format(iou_aps[cls_id, iou_thres_list.index(0.75)] * 100))
        print('5 degree, 5cm: {:.3f}'.format(pose_aps[cls_id, degree_thres_list.index(5),shift_thres_list.index(5)] * 100))
        print('5 degree, 100cm: {:.3f}'.format(pose_aps[cls_id, degree_thres_list.index(5),shift_thres_list.index(100)] * 100))
        print('10 degree, 5cm: {:.3f}'.format(pose_aps[cls_id, degree_thres_list.index(10),shift_thres_list.index(5)] * 100))
        print('10 degree, 10cm: {:.3f}'.format(pose_aps[cls_id, degree_thres_list.index(10),shift_thres_list.index(10)] * 100))
        print('15 degree, 5cm: {:.3f}'.format(pose_aps[cls_id, degree_thres_list.index(15),shift_thres_list.index(5)] * 100))
        print('15 degree, 10cm: {:.3f}'.format(pose_aps[cls_id, degree_thres_list.index(15),shift_thres_list.index(10)] * 100))
        print('')
