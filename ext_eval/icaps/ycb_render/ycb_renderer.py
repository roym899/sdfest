...
class YCBRenderer:
    def __init__(self, width=512, height=512, gpu_id=0, render_marker=False):
    ...
    def render(self, cls_indexes, image_tensor, seg_tensor, pc1_tensor=None, pc2_tensor=None):
        ...
        for i in range(len(cls_indexes)):
            ...
            if is_texture:
                ...
                GL.glUniformMatrix4fv(GL.glGetUniformLocation(self.shaderProgram_textureless, 'V'), 1, GL.GL_TRUE,
                                      self.V)
...
if __name__ == '__main__':
    ...
    while True:
        renderer.render([1, 2], tensor, seg_tensor=tensor2, pc2_tensor=pc_tensor)
